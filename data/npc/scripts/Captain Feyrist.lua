...
addTravelKeyword('thais', 0, Position(32369, 32240, 7))
...
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}?'})
