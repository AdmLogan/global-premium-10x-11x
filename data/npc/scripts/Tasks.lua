...
local monsters = {
   ["Sea Serpents"] = {storage = 5010, mstorage = 19000, amount = 10, exp = 5000, items = {{id = 2157, count = 1}, {id = 2160, count = 3}}},
   ["Ice Dragons"] = {storage = 5011, mstorage = 19001, amount = 10, exp = 10000, items = {{id = 2492, count = 1}, {id = 2160, count = 5}}},
   ["Elder Wyrms"] = {storage = 5012, mstorage = 19002, amount = 10, exp = 18000, items = {{id = 2195, count = 1}, {id = 2157, count = 8}}},
   ["Seacrest Serpents"] = {storage = 5013, mstorage = 19003, amount = 10, exp = 20000, items = {{id = 2520, count = 1}, {id = 2160, count = 10}}}
}
     ...
     if not npcHandler:isFocused(cid) then
         if msg == "hi" or msg == "hello" then
             ...
             if player:getStorageValue(storage) == -1 then
                 ...
                 if n > 1 then
                     npcHandler:say("Eu tenho varias Tasks para voce matar monstros"..text..", qual deles voce escolhe? Tambem posso mostrar uma {list} com recompensas e voce pode {stop} uma Task se quiser.", cid)
