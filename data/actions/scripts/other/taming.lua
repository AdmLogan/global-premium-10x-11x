...
local config = {
	...
	[13298]	=	{NAME = 'Terror Bird',				ID = 2,		TYPE = TYPE_MONSTER,	CHANCE = 20,	FAIL_MSG = { {1, 'The bird ran away.'}, {3, 'The terror bird is pecking you.'} }, SUCCESS_MSG = 'You have tamed the bird.'},
	...
	[13939]	=	{NAME = 'Wild Horse',				ID = 17,	TYPE = TYPE_MONSTER,	CHANCE = 20,	FAIL_MSG = { {1, 'The horse runs away.'}, {2, 'The horse ate the oats.'} }, SUCCESS_MSG = 'You have tamed the horse.'},
