...
function onLogin(player)
	...
	player:sendTextMessage(messageType or MESSAGE_STATUS_CONSOLE_ORANGE, '[DONATE] realize donate de qualquer valor e receba 2x em Coins')
    player:sendTextMessage(messageType or MESSAGE_STATUS_CONSOLE_ORANGE, '[Metodo de Pagamento] Aceitamos via PayPal, loterica, transferencia bancaria e PicPay')
    player:sendTextMessage(messageType or MESSAGE_STATUS_CONSOLE_ORANGE, '[Report] Para reportar qualquer problema utilize control + z')
	player:sendTextMessage(messageType or MESSAGE_STATUS_CONSOLE_ORANGE, '[Quests / Acessos] Nossas quests e acessos sao facilitados.')
	player:sendTextMessage(messageType or MESSAGE_STATUS_CONSOLE_ORANGE, '[SITE] xtibia.ml')
